...
//             }
//             var userid = User.FindFirstValue(ClaimTypes.NameIdentifier);
//             var category = await _context.Categories.SingleOrDefaultAsync(m => m.Cateid == id && m.AuthorId == userid);
//             if (category == null)
//             {
//                 return NotFound();
//             }
...
//                 {
//                     var userid = User.FindFirstValue(ClaimTypes.NameIdentifier);
//                     var data = await _context.Categories.SingleOrDefaultAsync(m => m.Cateid == id && m.AuthorId == userid);
//                     if (data == null)
//                     {
//                         return NotFound();
//                     }
